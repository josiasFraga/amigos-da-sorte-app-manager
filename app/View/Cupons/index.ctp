...
<div class="page-title">
	<h1>Números da Sorte <small>administrar Números da Sorte</small></h1>
</div>
<!-- END PAGE TITLE -->
</div>
<!-- END PAGE HEAD -->
...
<div class="col-md-12">
	...
	<div class="portlet light bordered">
		<div class="portlet-title">
			<div class="caption">
				<i class="font-dark"></i>
				<span class="caption-subject font-dark bold uppercase">Números da Sorte</span>
			</div>
		</div>
		<div class="portlet-body">
			<div class="">
				<table class="table table-striped table-bordered table-hover table-checkable" id="table-cupons">
					<thead>
						<tr>
							<th class="table-checkbox" width="20px">
								<input type="checkbox" class="group-checkable" data-set="#table-cupons .checkboxes"/>
							</th>
							<th>Cadastrado em</th>
							<th>Usuário</th>
							<th>Campanha</th>
...
<?php $this->Html->script('/js/Cupons/index', array('block' => 'scriptBottom')); ?>
