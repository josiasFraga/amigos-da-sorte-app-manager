		...
		<div class="portlet light bordered">
			<div class="portlet-title">
				<div class="caption">
					...
					<span class="caption-subject font-dark bold uppercase">Encontrar Ganhador</span>
					<span class="caption-helper"></span>
				</div>
			</div>
			<div class="portlet-body form">
				<!-- BEGIN FORM-->
				<form class="" action="#" method="post" enctype="multipart/form-data" id="encontrar-ganhador" autocomplete="off">
								...
								<div class="row">
									<div class="col-md-12">
										<div class="form-group">
											<label class="control-label">Nº sorteado pela Caixa/Ministério da Economia: <span class="required">*</span></label>
											<div class="input-icon left">
												<i class="fa"></i>
												<input type="text" class="form-control required number" name="data[numero]" maxlength="20" />
											</div>
										</div>
									</div>
								</div><!-- ./row -->
					...
					<div class="form-actions">
						<div class="row">
							<div class="text-right">
								...
								<button class="btn green" type="submit"><i class="fa fa-check"></i> Encontrar</button>
							</div>
						</div>
					</div>
...
$this->Html->script('/js/Cupons/encontrar_ganhador.js?v=1.0.1', array('block' => 'scriptBottom'));
