...
<div class="page-title">
	<h1>Campanhas <small>administrar Cupons</small></h1>
</div>
<!-- END PAGE TITLE -->
</div>
<!-- END PAGE HEAD -->
...
<div class="col-md-12">
	...
	<div class="portlet light bordered">
		<div class="portlet-title">
			<div class="caption">
				<i class="font-dark"></i>
				<span class="caption-subject font-dark bold uppercase">Campanhas</span>
			</div>
			<div class="actions">
				<a role="button" data-toggle="" href="<?php echo $this->Html->url(array('controller' => 'campanhas', 'action' => 'adicionar')) ?>" class="btn btn-circle btn-success">
					<i class="fa fa-plus"></i> Incluir </a>
			</div>
		</div>
		<div class="portlet-body">
			<div class="">
				<table class="table table-striped table-bordered table-hover table-checkable" id="table-campanhas">
					<thead>
						<tr>
							<th class="table-checkbox" width="20px">
								<input type="checkbox" class="group-checkable" data-set="#table-campanhas .checkboxes"/>
							</th>
							<th>Cadastrado em</th>
							<th>Nome</th>
							<th>Início</th>
						...
						<tr role="row" class="filter">
							...
							<td>
								<input type="date" class="form-control form-filter input-sm" name="inicio_de" value="" style="margin-bottom:4px">
								<input type="date" class="form-control form-filter input-sm" name="inicio_ate" value="">
							</td>
							<td>
								<input type="date" class="form-control form-filter input-sm" name="fim_de" value="" style="margin-bottom:4px">
								<input type="date" class="form-control form-filter input-sm" name="fim_ate" value="">
							</td>
							<td>
...
<?php $this->Html->script('/js/Campanhas/index', array('block' => 'scriptBottom')); ?>
