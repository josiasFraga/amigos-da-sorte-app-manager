<!-- BEGIN PAGE HEADER-->
    ...
    <div class="page-head">
        ...
        <div class="page-title">
            <h1>Campanhas <small>alterar campanha</small></h1>
        </div>
        <!-- END PAGE TITLE -->
    </div>
    <!-- END PAGE HEAD -->
        ...
        <div class="portlet light portlet-fit portlet-datatable bordered">
            <div class="portlet-title tabbable-line">
                <div class="caption">
                    ...
                    <span class="caption-subject font-dark sbold uppercase"> Alterar Campanha </span>
                </div>
            </div>
            <div class="portlet-body">
                <!-- BEGIN FORM-->
				<form class="" action="" method="post" enctype="multipart/form-data" id="alterar-campanha" autocomplete="off">
                    <input type="hidden" class="form-control form-filter input-sm required" name="data[Campanha][id]" placeholder="" id="id" value="<?php echo $id ?>">
					...
					<div class="form-body">
						...
						<div class="row">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group">
                                    <label class="control-label">Imagem: (Deixe em branco para não alterar)</label>
                                    <input type="file" class="form-control form-filter input-sm" name="data[Campanha][imagem]" placeholder="" id="img">
                                </div>
                            </div>
                        </div>
...
$this->Html->script('/js/Campanhas/alterar.js?v=1.0', array('block' => 'scriptBottom'));
